...
var WysiwygEditor = function (_Component) {
	...
	(0, _createClass3.default)(WysiwygEditor, [{
		...
		value: function render() {
			...
			var toolBarContent = _react2.default.createElement(
				'div',
				{
			...
			return _react2.default.createElement(
				...
				!toolbarHidden && !!this.props.toolbarWrapper && this.props.toolbarWrapper(toolBarContent),
				!toolbarHidden && !this.props.toolbarWrapper && toolBarContent,
...
var _initialiseProps = function _initialiseProps() {
	...
	this.filterEditorProps = function (props) {
		return (0, _common.filter)(props, ['onChange', 'onEditorStateChange', 'onContentStateChange', 'initialContentState', 'defaultContentState', 'contentState', 'editorState', 'defaultEditorState', 'locale', 'localization', 'toolbarOnFocus', 'toolbar', 'toolbarCustomButtons', 'toolbarClassName', 'editorClassName', 'toolbarHidden', 'wrapperClassName', 'toolbarStyle', 'editorStyle', 'wrapperStyle', 'uploadCallback', 'onFocus', 'onBlur', 'toolbarWrapper', 'onTab', 'mention', 'hashtag', 'blockRenderMap', 'ariaLabel', 'customBlockRenderFunc', 'customDecorators', 'handlePastedText']);
	};
